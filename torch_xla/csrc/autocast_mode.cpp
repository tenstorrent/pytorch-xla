...
#define KERNEL_XLA(OP, POLICY) KERNEL(c10::DeviceType::PrivateUse1, OP, POLICY)
...
#define KERNEL_DIFFERENT_REDISPATCH_SIGNATURE_XLA(                             \
    ...
    POLICY)                                                                    \
  KERNEL_DIFFERENT_REDISPATCH_SIGNATURE(c10::DeviceType::PrivateUse1,          \
                                        REDISPATCH_FUNC, REGISTER_NAME,        \
                                        REGISTER_SIGNATURE,                    \
